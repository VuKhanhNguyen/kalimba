...
!(function () {
  var e = {
    ...
    themeToLocalStorage(e) {
      window.localStorage &&
        window.localStorage.setItem(this.localStorageKey, e);
    },
    init() {
    ...
    setActiveButton(e) {
      ...
      document
        .querySelector(this.selectorButton + '[data-color="' + e + '"]')
        .setAttribute("class", "picked");
    },
    ...
    generateTheme(e) {
      ...
      let f = {
        ...
        ".c600": e[600],
        ".c700": e[700],
        ".c600-outline-light": this.hexToRgbA(e[600], 0.125),
        ".c600-outline-dark": this.hexToRgbA(e[600], 0.25),
        ".inverse": e.inverse,
      };
      Object.keys(f).forEach((a) => {
        document
          .querySelectorAll(this.selectorSection + " " + a)
          .forEach((e) => {
            e.innerHTML = f[a];
          });
      });
      a = `
                ...
                --primary: ${e[600]};
                --primary-hover: ${e[700]};
                --primary-focus: ${this.hexToRgbA(e[600], 0.125)};
                ...
                :root:not([data-theme="light"]) [data-theme="generated"] {
                    ...
                    --primary: ${e[600]};
                    --primary-hover: ${e[500]};
                    --primary-focus: ${this.hexToRgbA(e[600], 0.25)};
                    --primary-inverse: ${e.inverse};
                }
                }
        ...
        return (
          ...
          [
            ((f =
              "0x" +
              (f =
                3 == (f = e.substring(1).split("")).length
  ...
  function initWhenReady(attempt) {
    ...
    // React/Vite pages may render the target later.
    if (document.querySelector(e.buttonsTarget)) {
      e.init();
      return;
    }
